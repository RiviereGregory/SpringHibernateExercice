DROP DATABASE IF EXISTS gestionprojet;
CREATE DATABASE gestionprojet;
USE gestionprojet;

CREATE TABLE DEPARTMENT (ID INTEGER NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), PRIMARY KEY (ID));
CREATE TABLE PROJECT (ID INTEGER NOT NULL AUTO_INCREMENT, DTYPE VARCHAR(31), NAME VARCHAR(255), PRIMARY KEY (ID));
CREATE TABLE PROJECT_EMPLOYEE (EMPLOYEES_ID INTEGER, PROJECTS_ID INTEGER);
CREATE TABLE EMPLOYEE (ID INTEGER NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), SALARY BIGINT, STARTDATE DATE, ADDRESS_ID INTEGER, DEPARTMENT_ID INTEGER, MANAGER_ID INTEGER, PRIMARY KEY (ID));
CREATE TABLE PHONE (ID BIGINT NOT NULL AUTO_INCREMENT, NUMBER VARCHAR(255), TYPE VARCHAR(255), EMPLOYEE_ID INTEGER, PRIMARY KEY (ID));
CREATE TABLE ADDRESS (ID INTEGER NOT NULL AUTO_INCREMENT, CITY VARCHAR(255), STATE VARCHAR(255), STREET VARCHAR(255), ZIP VARCHAR(255), PRIMARY KEY (ID));
...
INSERT INTO PROJECT (ID, NAME, DTYPE) VALUES (4, 'Implement Release3', 'DP');
